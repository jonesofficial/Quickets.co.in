            ...
            <div className="relative z-30 flex flex-col items-center justify-center h-full text-center">
                ...
                <div className="relative inline-block">
                    ...
                    <h1 className="font-heading text-[132px] md:text-[230px] leading-[0.68] relative">
                        BOOKIN
                        <span className="relative inline-block w-[0.9em]">
                            G
                            {/* G Gateway Anchor */}
                    ...
                    {/* VEHICLE EMERGENCE LAYER */}
                    <div className="absolute left-1/2 top-[55%] md:top-[52%] -translate-x-1/2 -translate-y-1/2 pointer-events-none">
                        ...
                        <img
                            ...
                            className={`
                                ...
                                drop-shadow-[0_35px_40px_rgba(0,0,0,0.85)]
                                ${animate
                                ? "-translate-x-[260px] translate-y-[40px] opacity-100"
                        ...
                        <img
                            ...
                            className={`
                                ...
                                drop-shadow-[0_35px_40px_rgba(0,0,0,0.85)]
                                ${animate
                                ? "translate-x-[280px] -translate-y-[20px] opacity-100"
                                : "translate-x-0 translate-y-0 opacity-0"
                            }
                            `}
                        />
